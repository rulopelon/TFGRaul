...
load("variables.mat","PLOT","BATCH_SIZE")
...
for batch = 1:1:columns
    ...
    [cross_correlation,~] = xcorr(surveillance_batches(:,batch),reference_batches(:,batch),BATCH_SIZE); 
...
if PLOT
    ...
    nombre = inpput("Introduzca el nombre de la figura");
