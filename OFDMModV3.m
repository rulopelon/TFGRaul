...
load("variables.mat","NFFT","L","PREFIX","CARRIERS","M","Fs_used","nAM","reconstruction_filter","symbol_length")
...
%%
alocation = zeros(symbol_length,Nsym);
ofdm_exit_2 = [];
...
for iteration = 1:1:Nsym
    ...
    alocation(:,iteration) = ofdmSymbolsSended';
...
ofdmSymbolsSe = interpolation(alocation,M);
...
%Decimation
ofdm_exit = ofdmSymbolsSe_processed(1:L:length(ofdmSymbolsSe_processed));
