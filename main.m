...
while i< NUMBER_ITERATIONS    
    ...
    % Calculus of the losses
    power_recieved_desired = (POWER_TRANSMITED*RADAR_CROSS_SECTION*GAIN_EMITTER*GAIN_RECIEVER*LAMBDA^2)/((4*pi)^3*(distance_emitter_target*1000)^2*(distance_target_reciever*1000)^2);    
